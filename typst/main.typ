...
+ A *baseline benchmark* replicating the Hagedorn hepatotoxicity @hagedorn_hepatotoxic_2013 and neurotoxicity @hagedorn_acute_2022 models on OligoStack with proper GroupKFold cross-validation by target gene, establishing reference performance for future methods.
